  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[var(--bd-bg)] text-[var(--bd-text)]">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 12% 18%, rgba(60,124,255,0.18), transparent 28%), radial-gradient(circle at 84% 14%, rgba(97,221,255,0.15), transparent 26%), radial-gradient(circle at 70% 72%, rgba(123,255,241,0.12), transparent 24%), linear-gradient(180deg, rgba(255,255,255,0.03), transparent 28%)",
        }}
      />
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.14] bd-grid-drift"
        style={{
          backgroundImage:
      ...
      <div className="pointer-events-none absolute left-[-8rem] top-24 h-80 w-80 rounded-full blur-[110px]" style={{ background: "rgba(60,124,255,0.16)" }} />
      <div className="pointer-events-none absolute right-[-10rem] top-0 h-[28rem] w-[28rem] rounded-full blur-[120px]" style={{ background: "rgba(97,221,255,0.14)" }} />
      <div className="pointer-events-none absolute bottom-[-8rem] left-1/2 h-[24rem] w-[24rem] -translate-x-1/2 rounded-full blur-[120px]" style={{ background: "rgba(123,255,241,0.12)" }} />
      ...
      <nav className="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-5 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          <div
            ...
            style={{
              ...
              background: "linear-gradient(135deg, rgba(60,124,255,0.24), rgba(97,221,255,0.24))",
            }}
          >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link href="/auth">
            <Button
              className="rounded-full border-0 px-5 font-semibold text-black bd-neon-button"
              style={{ background: "linear-gradient(135deg, var(--bd-gold), #8fe8ff)" }}
            >
              Join Beta
            </Button>
          </Link>
      ...
      <section className="relative z-10 mx-auto grid max-w-7xl gap-12 px-5 pb-14 pt-8 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10 lg:px-8 lg:pb-24 lg:pt-14">
        <div className="max-w-3xl">
          ...
          <div className="page-enter page-enter-delay-3 mt-8 flex flex-col gap-3 sm:flex-row">
            <Link href="/auth">
              <Button
                size="lg"
                className="group rounded-full border-0 px-8 py-6 text-base font-semibold text-black bd-neon-button"
                style={{ background: "linear-gradient(135deg, var(--bd-gold), #8fe8ff)" }}
              >
        ...
        <div className="relative page-enter page-enter-delay-4">
          <div
            ...
            style={{ background: "rgba(60,124,255,0.22)" }}
          />

          <div
            className="relative overflow-hidden rounded-[2rem] border p-4 sm:p-5 bd-scanlines bd-neon-border"
            style={{
              background:
          ...
          >
            <div className="flex items-center justify-between rounded-[1.4rem] border px-4 py-3" style={{ borderColor: "rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.03)" }}>
              ...
              <div className="rounded-full border px-3 py-1 text-xs text-[var(--bd-green)]" style={{ borderColor: "rgba(123,255,241,0.24)", background: "rgba(123,255,241,0.08)" }}>
                Intent match +92
              </div>
            </div>
            ...
            <div className="mt-4 grid gap-4 lg:grid-cols-[0.88fr_1.12fr]">
              <div className="space-y-4">
                <div className="rounded-[1.5rem] border p-4" style={{ borderColor: "rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.03)" }}>
                  <div className="flex items-center gap-3">
                    <div className="flex h-11 w-11 items-center justify-center rounded-2xl text-lg" style={{ background: "rgba(60,124,255,0.14)" }}>
                      A
                    </div>
                    <div>
                ...
                <div className="rounded-[1.5rem] border p-4" style={{ borderColor: "rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.03)" }}>
                  <div className="flex items-center gap-3">
                    <div className="flex h-11 w-11 items-center justify-center rounded-2xl text-lg" style={{ background: "rgba(97,221,255,0.14)" }}>
                      M
                    </div>
                    <div>
                ...
                <div className="rounded-[1.5rem] border p-4" style={{ borderColor: "rgba(255,255,255,0.08)", background: "linear-gradient(180deg, rgba(60,124,255,0.08), rgba(255,255,255,0.03))" }}>
              ...
              <div className="rounded-[1.75rem] border p-5" style={{ borderColor: "rgba(255,255,255,0.08)", background: "linear-gradient(180deg, rgba(255,255,255,0.04), rgba(255,255,255,0.02))" }}>
                ...
                <div className="mt-6 rounded-[1.4rem] border px-4 py-4" style={{ borderColor: "rgba(123,255,241,0.18)", background: "rgba(123,255,241,0.06)" }}>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-4 md:grid-cols-3">
          {HIGHLIGHTS.map((item, index) => (
            <div
              key={item.title}
                className={`rounded-[1.8rem] border p-6 page-enter page-enter-delay-${Math.min(index + 1, 5)} bd-card-hover`}
              style={{
                  borderColor: "rgba(83,184,255,0.2)",
                  background: "linear-gradient(180deg, rgba(83,184,255,0.08), rgba(255,255,255,0.018))",
              }}
            >
              <div className="mb-3 text-xs uppercase tracking-[0.24em] text-[var(--bd-text-faint)]">
                Why it feels different
              </div>
              <h2 className="text-2xl font-semibold tracking-[-0.04em] text-[var(--bd-text)]">{item.title}</h2>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-20 sm:px-6 lg:px-8" id="difference">
        ...
        <div className="mt-10 overflow-hidden rounded-[2rem] border bd-neon-border" style={{ borderColor: "rgba(83,184,255,0.2)" }}>
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 py-20 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="rounded-[2rem] border p-6 sm:p-8 bd-neon-border" style={{ borderColor: "rgba(83,184,255,0.2)", background: "linear-gradient(180deg, rgba(83,184,255,0.06), rgba(255,255,255,0.02))" }}>
            <div className="flex items-center gap-2 text-[var(--bd-gold)]">
          ...
          <div className="grid gap-4">
            <div className="rounded-[2rem] border p-6 sm:p-8 bd-neon-border" style={{ borderColor: "rgba(83,184,255,0.2)", background: "linear-gradient(135deg, rgba(60,124,255,0.12), rgba(97,221,255,0.1) 55%, rgba(255,255,255,0.03))" }}>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {TESTIMONIALS.map((item) => (
                <div
                  key={item.author}
                  className="rounded-[1.8rem] border p-5 bd-card-hover"
                  style={{
                    borderColor: "rgba(83,184,255,0.2)",
                    background: "linear-gradient(180deg, rgba(83,184,255,0.08), rgba(255,255,255,0.015))",
                  }}
                >
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-5 pb-24 pt-8 sm:px-6 lg:px-8">
        <div
          className="overflow-hidden rounded-[2.4rem] border px-6 py-8 sm:px-10 sm:py-10 bd-scanlines bd-neon-border"
          style={{
            borderColor: "rgba(83,184,255,0.24)",
            background:
              "linear-gradient(135deg, rgba(60,124,255,0.12), rgba(97,221,255,0.1) 42%, rgba(123,255,241,0.09) 100%)",
          }}
        >
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link href="/auth">
                <Button
                  size="lg"
                  className="rounded-full border-0 px-8 py-6 text-base font-semibold text-black bd-neon-button"
                  style={{ background: "linear-gradient(135deg, var(--bd-gold), #8fe8ff)" }}
                >
                  Start your profile
                </Button>
